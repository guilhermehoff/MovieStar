        ...
        <div class="offset-md-4 col-md-4 new-movie-container">
            ...
            <form action="<?= $BASE_URL ?>movie_process.php" id="add-movie-form" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="Digíte o título do seu filme">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="length" name="length" placeholder="Digíte a duração seu filme">
                </div>
                <div class="form-group">
