<?php
    ...
    if(empty($id)) {
        ...
        if(!empty($userData)) {
            ...
            $message->setMessage("Usuário não encontrado. Faça login para continuar!", "error", "index.php");
        ...
        <div class="col-md-8 offset-md-2">
            <div class="row profile-container">
                <div class="col-md-12 about-container">
                    ...
                    <?php else: ?>
                        <p class="profile-description">Ops! Esse usuário ainda não fez a sua biografia!</p>
                    <?php endif; ?>
                </div>
