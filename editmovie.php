        ...
        <div class="row">
            <div class="col-md-6 offset-md-1">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="Digíte o título do seu filme" value="<?= $movie->title ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="length" name="length" placeholder="Digíte a duração seu filme" value="<?=$movie->length ?>">
                </div>
                <div class="form-group">
